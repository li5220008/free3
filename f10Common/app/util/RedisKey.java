...
public class RedisKey {
    ...
    public static class TopManager {
        public static final String topManagerP353 = "37a_";  //高管信息(包含了高管人员, 董事会, 监事会) 加上 institutionId,  List<TopManager>结果集, 压缩存储
        public static final String topManagerP351 = "37b_";  //高管信息(包含了高管人员, 董事会, 监事会) 加上 institutionId,  List<TopManager>结果集, 压缩存储
        public static final String topManagerP352 = "37c_";  //高管信息(包含了高管人员, 董事会, 监事会) 加上 institutionId,  List<TopManager>结果集, 压缩存储
        ...
        public static final String holdingchange = "40_"; //高管持股变动 加上 symbol  List<HoldingChange> 按日期 降序
    }
