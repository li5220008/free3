...
public class HighChartDataType {
    ...
    public static String toJsonWithHighChartDataType(Object o) {
        Gson gson = new GsonBuilder().registerTypeAdapter(HighChartDataType.HCDate.class, new JsonSerializer<HCDate>() {
            public JsonElement serialize(HighChartDataType.HCDate src, Type typeOfSrc, JsonSerializationContext context) {
                return new JsonPrimitive(new HighChartDataType.HCDateNumber(src.getAsString()));
            }
        }).create();
