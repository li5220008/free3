...
public class CustomDbUtil {
    ...
    public static final String CUSTOM_DB_CONF_NAME = "custom";
     ...
     * 返回提取数据的数据库连接
     */
    public static Connection getCustomDBConnection() {
        return DB.getDBConfig(CUSTOM_DB_CONF_NAME, false).getConnection();
    }

    /**
     * 在提取数据的数据库上执行sql. (一般是执行对数据库有更新的那种)
     */
    public static boolean execute4CustomDB(String SQL) {
        return DB.getDBConfig(CUSTOM_DB_CONF_NAME, false).execute(SQL);
    }

    /**
     * 在提取数据的数据库上执行sql语句(查询类)
     */
    public static ResultSet executeQuery4CustomDB(String SQL) {
        return DB.getDBConfig(CUSTOM_DB_CONF_NAME, false).executeQuery(SQL);
    }
    ...
    public static <T> T queryOneFieldOneRow(String sql, Class<T> cl, Object... params){
        Connection conn = getCustomDBConnection();
     ...
     */
    public static <T> T queryCustomDBSingleBean(String sql, Class<T> cl, Object... params) {
        Connection conn = getCustomDBConnection();
     ...
     */
    public static <T> List<T> queryCustomDBBeanList(String sql, Class<T> cl, Object... params) {
        Connection conn = getCustomDBConnection();
     ...
     */
    public static Map<String, Object> queryCustomDBSingleMap(String sql, Object... params) {
        Connection conn = getCustomDBConnection();
     ...
     * @return
     */
    public static <T> T queryCustomDbWithHandler(String sql, ResultSetHandler<T> rsh, Object... params) {
        Connection conn = getCustomDBConnection();
        try {
     ...
     * 如果没有,则返回的list长度为0
     */
    public static List<Map<String, Object>> queryCustomDBMapList(String sql, Object... params) {
        Connection conn = getCustomDBConnection();
     ...
     */
    public static int updateCustomDB(String sql, Object... param){
        Connection conn = getCustomDBConnection();
        try {
