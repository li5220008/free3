 ...
 * Time: 下午4:48
 */
public abstract class ExtractDbUtil {
     ...
     */
    public static Map<String, Object> queryExtractDBSingleMap(String sql, Object... params) {
        Connection conn = getExtractDBConnection();
     ...
     * 如果没有,则返回的list长度为0
     */
    public static List<Map<String, Object>> queryExtractDBMapList(String sql, Object... params) {
        Connection conn = getExtractDBConnection();
