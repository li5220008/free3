...
public class AdvanceInfomationSearchProcessor implements Processor{
    ...
    public ResponseModel process() {
       ...
       //新加股票代码
        paramMap.put("symbols",RequestContext.getArray(Protocol.InfomationSearchFieldName.SYMBOL));
        ...
        paramMap.put("niids",RequestContext.getArray(Protocol.InfomationSearchFieldName.NIIDS));
