...
public interface NewsService {
    ...
    /**
     * 索引字段名描述
     * 请注意这里对应的字段的值 要跟 Protocol.InfomationSearchFieldName 相应字段的值一样, 不然可能会出错.
     * 如: InfomationSearchFieldName.TYPE = 'itype' 与
     *     DOCUMENT_TYPE = 'itype'
     * 这两个值一样
     */
    public static class InfomationFieldMapping {
         ...
         * 研报来源机构名称
         */
        public static final String REPORT_SOURCE_NAME= "rsnames";

        /**
         * 研报作者
         */
        public static final String REPORT_AUTHOR= "rauthor";
