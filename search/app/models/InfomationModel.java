...
public class InfomationModel extends DataModelAdaptor {
     ...
     * 新闻来源
     */
    @SerializedName(Protocol.InfomationSearchFieldName.NSOURCE)
    @Expose
     ...
     * 研报来源名称
     */
    @SerializedName(Protocol.InfomationSearchFieldName.RSOURCE_Name)
    @Expose
    public List<String> rSourceNames;

    /**
     * 研报作者
     */
    @SerializedName(Protocol.InfomationSearchFieldName.RAUTHOR)
    @Expose
    public List<String> rAuthors;
