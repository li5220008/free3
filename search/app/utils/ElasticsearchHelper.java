...
public class ElasticsearchHelper {
    ...
    public static void recordDirtyData(long id,String reason,String type) throws IOException {
        BulkRequestBuilder bulkRequestBuilder = ElasticsearchHelper.getClient().prepareBulk();
        bulkRequestBuilder.add(ElasticsearchHelper.getClient().prepareIndex("dirty_data", "news")
        ...
        indexByBulk(bulkRequestBuilder);
    }
